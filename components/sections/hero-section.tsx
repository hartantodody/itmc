...
function StatCard({ icon: Icon, value, label }: StatCardProps) {
  ...
  return (
    <div className='relative overflow-hidden rounded-2xl border border-white/15 bg-white/10 p-3.5 backdrop-blur-xl'>
            ...
            <div className='relative aspect-[4/3] w-full overflow-hidden rounded-3xl border border-white/18 bg-white/10 shadow-2xl backdrop-blur-xl'>
              ...
              <div className='relative grid h-full w-full place-items-center p-8 text-center'>
                <div className='space-y-4'>
                  <div className='mx-auto grid h-16 w-16 place-items-center rounded-2xl border border-white/20 bg-white/10 text-2xl font-extrabold text-white shadow-lg imtc-anim-float'>
                    IM
                  </div>
